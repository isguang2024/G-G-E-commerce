...
- 失败定位：
  - 若只剩 `redirect=/system/page`，优先检查 [beforeEach.ts](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/router/guards/beforeEach.ts)
  - 若跳到错误 host，优先检查 [menu-space.ts](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/store/modules/menu-space.ts) 与 [ArtAppSwitcher.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/components/core/layouts/art-header-bar/widget/ArtAppSwitcher.vue)
...
- 失败定位：
  - 若被覆盖到 `/account/auth/login?redirect=/demo/lab`，优先检查 [art-header-bar/index.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/components/core/layouts/art-header-bar/index.vue) 与 [ArtAppSwitcher.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/components/core/layouts/art-header-bar/widget/ArtAppSwitcher.vue)
  - 若公开页本身 404，优先检查 [ManagedPageProcessor.ts](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/router/core/ManagedPageProcessor.ts) 与运行时页面注册链
...
- 失败定位：
  - 若 callback 失败，优先检查 [frontend/src/views/auth/callback/index.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/views/auth/callback/index.vue) 与后端 centralized auth service
  - 若登录成功但没回到目标页，优先检查 [login/index.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/views/auth/login/index.vue) 的 `gotoAfterLogin`
...
- 期望：
  ...
  - 控制台 `error = 0`
- 失败定位：
  - 若切到错误入口或 404，优先检查 [ArtAppSwitcher.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/components/core/layouts/art-header-bar/widget/ArtAppSwitcher.vue)
  - 若切回后台后菜单为空，优先检查 [beforeEach.ts](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/router/guards/beforeEach.ts) 与 runtime navigation 刷新链
...
- 失败定位：
  - `App 管理` 异常优先看 [frontend/src/views/system/app/index.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/views/system/app/index.vue)
  - `页面管理` 异常优先看 [frontend/src/views/system/page/index.vue](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/frontend/src/views/system/page/index.vue)
  - 若是运行时接口 404，先对照 [backend/internal/api/router/router_contract_test.go](/C:/Users/Administrator/Documents/GitHub/MaBen Admin/backend/internal/api/router/router_contract_test.go)

...
> 后端开发真相。单文档收口——架构、ADR、API、Driver 扩展、运维、故障排查全在这里。
> 前端使用指南看 `frontend/Truth/upload-sdk.md`。

## 关联文档

- 当前真相：
  - 扩展参数与 schema 约束：[schema-registry.md](./schema-registry.md)
  - 运维与配置示例：[ops-guide.md](./ops-guide.md)
  - 前端使用指南：`frontend/Truth/upload-sdk.md`
- 历史材料（仅追溯）：
  - `docs/tmp/upload-config-v2-design.md`
  - `docs/tmp/upload-config-v2-gap-analysis.md`
  - `docs/tmp/upload-config-v2-release.md`
  - `docs/tmp/upload-system-plan.md`
---

...
func (s *Server) decodeCompleteMediaUploadRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request MediaCompleteUploadRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeCreateDictItemRequest(r *http.Request) (
...
func (s *Server) decodeCreateLogPolicyRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request LogPolicyCreateRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeCreateStorageBucketRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request StorageBucketSaveRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeCreateStorageProviderRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request StorageProviderSaveRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeCreateUploadKeyRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request UploadKeySaveRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeCreateUploadKeyRuleRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request UploadKeyRuleSaveRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeExchangeSocialTokenRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request SocialTokenExchangeRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeIngestTelemetryLogsRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request TelemetryIngestRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePrepareMediaUploadRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request MediaPrepareUploadRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePreviewLogPolicyRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request LogPolicyPreviewRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateDictItemRequest(r *http.Request) (
	req *DictItemSaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUpdateLogPolicyRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request LogPolicyUpdateRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateSiteConfigRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request SiteConfigSaveRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateSiteConfigSetRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request SiteConfigSetSaveRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateSiteConfigSetItemsRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request SiteConfigSetItemsRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateStorageBucketRequest(r *http.Request) (
	req *StorageBucketSaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUpdateStorageProviderRequest(r *http.Request) (
	req *StorageProviderSaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUpdateUploadKeyRequest(r *http.Request) (
	req *UploadKeySaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUpdateUploadKeyRuleRequest(r *http.Request) (
	req *UploadKeyRuleSaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,
		...
		q := uri.NewQueryDecoder(form)
		{
			...
			if err := q.HasParam(cfg); err == nil {
				if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
					...
					request.Key.SetTo(requestDotKeyVal)
					return nil
				}); err != nil {
					return req, rawBody, close, errors.Wrap(err, "decode \"key\"")
				}
			}
		}
		{
			...
			if err := q.HasParam(cfg); err == nil {
				if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
					...
					request.Rule.SetTo(requestDotRuleVal)
					return nil
				}); err != nil {
					return req, rawBody, close, errors.Wrap(err, "decode \"rule\"")
				}
			}
		}
		{
...
func (s *Server) decodeUpsertSiteConfigRequest(r *http.Request) (
	req *SiteConfigSaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUpsertSiteConfigSetRequest(r *http.Request) (
	req *SiteConfigSetSaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,

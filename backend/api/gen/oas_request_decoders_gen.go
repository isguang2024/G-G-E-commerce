...
func (s *Server) decodeCreateApiEndpointRequest(r *http.Request) (
	req AnyObject,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeCreateMenuBackupRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request MenuBackupCreateRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeCreateMenuGroupRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request MenuGroupSaveRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeSaveApiEndpointScanConfigRequest(r *http.Request) (
	req AnyObject,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUpdateMenuGroupRequest(r *http.Request) (
	req *MenuGroupSaveRequest,
	rawBody []byte,
	close func() error,
	rerr error,

...
var mappings = map[string]Mapping{
	...
	"menu_backup:create":                     {Key: "system.menu.backup", ResourceCode: "menu_backup", ActionCode: "manage", Name: "菜单备份管理", Description: "允许创建、查看、恢复和删除菜单备份", ContextType: "personal"},
	"menu_backup:list":                       {Key: "system.menu.backup", ResourceCode: "menu_backup", ActionCode: "manage", Name: "菜单备份管理", Description: "允许创建、查看、恢复和删除菜单备份", ContextType: "personal"},
	"menu_backup:delete":                     {Key: "system.menu.backup", ResourceCode: "menu_backup", ActionCode: "manage", Name: "菜单备份管理", Description: "允许创建、查看、恢复和删除菜单备份", ContextType: "personal"},
	"menu_backup:restore":                    {Key: "system.menu.backup", ResourceCode: "menu_backup", ActionCode: "manage", Name: "菜单备份管理", Description: "允许创建、查看、恢复和删除菜单备份", ContextType: "personal"},

...
var mappings = map[string]Mapping{
	...
	"permission_action:list":                   {Key: "system.permission.manage", ResourceCode: "permission_action", ActionCode: "manage", Name: "功能权限管理", Description: "允许查看和维护功能权限", ContextType: "platform"},
	"permission_action:get":                    {Key: "system.permission.manage", ResourceCode: "permission_action", ActionCode: "manage", Name: "功能权限管理", Description: "允许查看和维护功能权限", ContextType: "platform"},
	"permission_action:create":                 {Key: "system.permission.manage", ResourceCode: "permission_action", ActionCode: "manage", Name: "功能权限管理", Description: "允许查看和维护功能权限", ContextType: "platform"},
	"permission_action:update":                 {Key: "system.permission.manage", ResourceCode: "permission_action", ActionCode: "manage", Name: "功能权限管理", Description: "允许查看和维护功能权限", ContextType: "platform"},
	"permission_action:delete":                 {Key: "system.permission.manage", ResourceCode: "permission_action", ActionCode: "manage", Name: "功能权限管理", Description: "允许查看和维护功能权限", ContextType: "platform"},
	...
	"tenant:configure_action_boundary":         {Key: "tenant.boundary.manage", ResourceCode: "tenant", ActionCode: "configure_action_boundary", Name: "平台团队功能边界管理", Description: "允许在系统管理中查看和配置任意团队的功能边界", ContextType: "platform"},
	"tenant:configure_menu_boundary":           {Key: "tenant.boundary.manage", ResourceCode: "tenant", ActionCode: "configure_menu_boundary", Name: "平台团队功能边界管理", Description: "允许在系统管理中查看和配置任意团队的菜单边界", ContextType: "platform"},
	"tenant_member_admin:list":                 {Key: "tenant.member.manage", ResourceCode: "tenant_member_admin", ActionCode: "manage", Name: "平台团队成员管理", Description: "允许在系统管理中查看和维护任意团队的成员", ContextType: "platform"},
	"tenant_member_admin:create":               {Key: "tenant.member.manage", ResourceCode: "tenant_member_admin", ActionCode: "manage", Name: "平台团队成员管理", Description: "允许在系统管理中查看和维护任意团队的成员", ContextType: "platform"},
	"tenant_member_admin:delete":               {Key: "tenant.member.manage", ResourceCode: "tenant_member_admin", ActionCode: "manage", Name: "平台团队成员管理", Description: "允许在系统管理中查看和维护任意团队的成员", ContextType: "platform"},
	"tenant_member_admin:update_role":          {Key: "tenant.member.manage", ResourceCode: "tenant_member_admin", ActionCode: "manage", Name: "平台团队成员管理", Description: "允许在系统管理中查看和维护任意团队的成员", ContextType: "platform"},
	...
	"system_permission:manage_action_registry": {Key: "system.permission.manage", ResourceCode: "permission_action", ActionCode: "manage", Name: "功能权限管理", Description: "允许查看和维护功能权限", ContextType: "platform"},

...
var mappings = map[string]Mapping{
	...
	"feature_package:list":                   {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "manage", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包", ContextType: "platform"},
	"feature_package:get":                    {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "manage", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包", ContextType: "platform"},
	"feature_package:create":                 {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "manage", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包", ContextType: "platform"},
	"feature_package:update":                 {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "manage", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包", ContextType: "platform"},
	"feature_package:delete":                 {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "manage", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包", ContextType: "platform"},
	"feature_package:assign_action":          {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "manage", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包", ContextType: "platform"},
	"feature_package:assign_bundle":          {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "manage", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包组合关系", ContextType: "platform"},
	...
	"feature_package:assign_menu":            {Key: "platform.package.manage", ResourceCode: "feature_package", ActionCode: "assign_menu", Name: "个人空间功能包管理", Description: "允许查看和维护个人空间功能包菜单", ContextType: "platform"},

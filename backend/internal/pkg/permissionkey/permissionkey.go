...
var mappings = map[string]Mapping{
	...
	"collaboration.message:manage":           {Key: "collaboration.message.manage", ResourceCode: "collaboration_message", ActionCode: "manage", Name: "协作消息发送", Description: "允许协作空间管理员向当前协作上下文发送站内通知、消息和待办", ContextType: "collaboration"},
	...
	"feature_package:assign_workspace":                           {Key: "feature_package.assign_workspace", ResourceCode: "feature_package", ActionCode: "assign_workspace", Name: "工作空间功能包开通", Description: "允许为工作空间开通和配置功能包", ContextType: "personal"},
	...
	"workspace:list":                                              {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间", ContextType: "personal"},
	"workspace:get":                                               {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间", ContextType: "personal"},
	"workspace:create":                                            {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间", ContextType: "personal"},
	"workspace:update":                                            {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间", ContextType: "personal"},
	"workspace:delete":                                            {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间", ContextType: "personal"},
	"workspace:configure_action_boundary":                         {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间及其边界", ContextType: "personal"},
	"workspace:configure_menu_boundary":                           {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间及其边界", ContextType: "personal"},
	"workspace_member_admin:list":                                 {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间及其成员", ContextType: "personal"},
	"workspace_member_admin:create":                               {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间及其成员", ContextType: "personal"},
	"workspace_member_admin:delete":                               {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间及其成员", ContextType: "personal"},
	"workspace_member_admin:update_role":                          {Key: "workspace.manage", ResourceCode: "workspace", ActionCode: "manage", Name: "工作空间管理", Description: "允许查看和维护协作工作空间及其成员", ContextType: "personal"},
	"collaboration_member:create":                                 {Key: "collaboration.member.manage", ResourceCode: "collaboration_member", ActionCode: "manage", Name: "当前协作成员管理", Description: "允许在当前协作上下文中查看和维护本协作空间成员", ContextType: "collaboration"},
	"collaboration_member:delete":                                 {Key: "collaboration.member.manage", ResourceCode: "collaboration_member", ActionCode: "manage", Name: "当前协作成员管理", Description: "允许在当前协作上下文中查看和维护本协作空间成员", ContextType: "collaboration"},
	"collaboration_member:update_role":                            {Key: "collaboration.member.manage", ResourceCode: "collaboration_member", ActionCode: "manage", Name: "当前协作成员管理", Description: "允许在当前协作上下文中查看和维护本协作空间成员", ContextType: "collaboration"},
	"collaboration_member:assign_role":                            {Key: "collaboration.member.manage", ResourceCode: "collaboration_member", ActionCode: "manage", Name: "当前协作成员管理", Description: "允许在当前协作上下文中为本协作空间成员分配角色", ContextType: "collaboration"},
	"collaboration_member:assign_action":                          {Key: "collaboration.member.manage", ResourceCode: "collaboration_member", ActionCode: "manage", Name: "当前协作成员管理", Description: "允许在当前协作上下文中为本协作空间成员配置功能权限", ContextType: "collaboration"},
	"collaboration_boundary:configure_action_boundary":            {Key: "collaboration.boundary.manage", ResourceCode: "collaboration_boundary", ActionCode: "manage", Name: "当前协作功能边界管理", Description: "允许在当前协作上下文中查看和配置本协作空间的功能边界", ContextType: "collaboration"},
	"workspace:configure_menu_boundary_current":                   {Key: "collaboration.boundary.manage", ResourceCode: "workspace", ActionCode: "configure_action_boundary", Name: "当前协作功能边界管理", Description: "允许在当前协作上下文中查看和配置本协作空间的菜单边界", ContextType: "collaboration"},
	"workspace:configure_action_boundary_current":                 {Key: "collaboration.boundary.manage", ResourceCode: "workspace", ActionCode: "configure_action_boundary", Name: "当前协作功能边界管理", Description: "允许在当前协作上下文中查看和配置本协作空间的功能边界", ContextType: "collaboration"},
...
func normalizeContextTypeForKey(permissionKey, contextType, moduleCode string) string {
	...
	case strings.HasPrefix(key, "system."),
		...
		strings.HasPrefix(key, "workspace_member_admin."),
		strings.HasPrefix(key, "collaboration_member."):
		return "common"
	case normalized != "":
		return normalized

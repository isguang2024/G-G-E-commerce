...
var fixedManagedRouteCodes = map[string]string{
	...
	routeKey("GET", "/api/v1/feature-packages/teams/:collaborationWorkspaceId"):                 "2d47541d-93ea-57f1-a4f3-78d65eec509c",
	routeKey("PUT", "/api/v1/feature-packages/teams/:collaborationWorkspaceId"):                 "ed783123-f7d6-56dd-93b1-cfd722244aeb",

...
func DefaultMenus() []MenuSeed {
	...
	items := []MenuSeed{
		...
		{Name: "LoginPageTemplate", ParentName: "SystemIntegration", Path: "/system/login-page-template", Component: "/system/login-page-template", Title: "登录页模板", SortOrder: 13, Meta: usermodel.MetaJSON{"roles": []interface{}{"R_SUPER"}, "keepAlive": true}},

...
func DefaultAPIEndpointCategories() []APIEndpointCategorySeed {
	items := []APIEndpointCategorySeed{
		...
		{Code: "tenant", Name: "协作空间", NameEn: "Tenant", SortOrder: 120, Status: "normal"},
...
func DefaultPermissionKeys() []PermissionKeySeed {
	items := []PermissionKeySeed{
		...
		newPermissionKeySeed("feature_package", "assign_team", "配置协作空间功能包", "允许给协作空间开通功能包"),
...
func DefaultPermissionModuleGroups() []PermissionGroupSeed {
	return []PermissionGroupSeed{
		...
		},
		{
			...
			Description: "平台协作空间、协作空间边界与协作空间主体治理",
			Status:      "normal",
			SortOrder:   160,
			IsBuiltin:   true,
		},
		{
			...
			Description: "平台侧协作空间成员与协作空间身份配置",
			Status:      "normal",
			SortOrder:   170,
			IsBuiltin:   true,
		},
...
func DefaultMenus() []MenuSeed {
	...
	items := []MenuSeed{
		...
		{Name: "CollaborationWorkspaceMessageManage", ParentName: "CollaborationWorkspaceRoot", Path: "message", Component: "/collaboration/message", Title: "协作空间消息发送", SortOrder: 4, Meta: metaTeamAccessOnly},
		...
		{Name: "CollaborationWorkspaceMembers", ParentName: "CollaborationWorkspaceRoot", Path: "members", Component: "/collaboration/team-members", Title: "协作空间成员", SortOrder: 2, Meta: metaTeamAccessOnly},
	}
	for i := range items {

...
func DefaultPermissionKeys() []PermissionKeySeed {
	items := []PermissionKeySeed{
		...
		newPermissionKeySeed("feature_package", "manage", "个人工作空间功能包管理", "允许查看和维护个人工作空间功能包"),
...
func DefaultPermissionModuleGroups() []PermissionGroupSeed {
	return []PermissionGroupSeed{
		...
		},
		{
			...
			Description: "个人工作空间用户、角色与例外权限管理",
			Status:      "normal",
			SortOrder:   120,
			IsBuiltin:   true,
		},
		{
			...
			Description: "个人工作空间菜单树维护与菜单权限治理",
			Status:      "normal",
			SortOrder:   130,
			IsBuiltin:   true,
		},
...
func DefaultFeaturePackages() []FeaturePackageSeed {
	items := []FeaturePackageSeed{
		...
		},
		{
			...
			PackageType:    "base",
			Name:           "个人工作空间菜单管理包",
			Description:    "包含个人工作空间菜单管理与菜单备份能力",
			ContextType:    "personal",
			IsBuiltin:      true,
			Status:         "normal",
			SortOrder:      2,
		...
		},
		{
			...
			PackageType:    "base",
			Name:           "个人工作空间接口管理包",
			Description:    "包含 API 注册表查看、同步与个人工作空间功能包治理能力",
			ContextType:    "personal",
			IsBuiltin:      true,
			Status:         "normal",
			SortOrder:      3,
		...
		},
		{
			...
			PackageType: "bundle",
			Name:        "个人工作空间管理员组合包",
			Description: "统一聚合个人工作空间系统、菜单与接口管理基础包",
			ContextType: "personal",
			IsBuiltin:   true,
			Status:      "normal",
			SortOrder:   4,

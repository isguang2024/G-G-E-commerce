	...
	items := []FeaturePackageSeed{
		{
			...
			Status:         "normal",
			SortOrder:      1,
			MenuNames:      []string{"System", "SystemAccess", "Role", "User", "ActionPermission", "FeaturePackage", "SystemNavigation", "AppManage", "Menus", "PageManagement", "FastEnterManage", "MenuSpaceManage", "AccessTrace", "SystemAccount", "RegisterEntry", "RegisterPolicy", "RegisterLog", "LoginPageTemplate", "SystemIntegration", "ApiEndpoint", "MessageManage", "Dictionary", "CollaborationWorkspaceRoot", "CollaborationWorkspaceManage", "CollaborationWorkspaceMembers", "CollaborationWorkspaceRolesAndPermissions"},
...
func DefaultMenus() []MenuSeed {
	...
	items := []MenuSeed{
		...
		{Name: "RegisterPolicy", ParentName: "SystemAccount", Path: "/system/register-policy", Component: "/system/register-policy", Title: "注册策略", SortOrder: 2, Meta: usermodel.MetaJSON{"roles": []interface{}{"R_SUPER"}, "keepAlive": true}},
		{Name: "RegisterLog", ParentName: "SystemAccount", Path: "/system/register-log", Component: "/system/register-log", Title: "注册记录", SortOrder: 3, Meta: usermodel.MetaJSON{"roles": []interface{}{"R_SUPER"}, "keepAlive": true}},

...
func (m *UserModule) RegisterRoutes(rg *gin.RouterGroup) {
	...
	userHandler := NewUserHandler(userService, packageRepo, platformService, boundaryService, roleRepo, userRoleRepo, userPackageRepo, userHiddenMenuRepo, menuRepo, refresher, m.logger)

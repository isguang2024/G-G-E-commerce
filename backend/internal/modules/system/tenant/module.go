...
func (m *TenantModule) RegisterRoutes(rg *gin.RouterGroup) {
	...
	reg.POST("/my-team/members", &apiregistry.RouteMeta{Summary: "添加当前团队成员", ResourceCode: "team_member", ActionCode: "create", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "create", "team"), tenantHandler.AddMyMember)
	reg.DELETE("/my-team/members/:userId", &apiregistry.RouteMeta{Summary: "移除当前团队成员", ResourceCode: "team_member", ActionCode: "delete", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "delete", "team"), tenantHandler.RemoveMyMember)
	reg.PUT("/my-team/members/:userId/role", &apiregistry.RouteMeta{Summary: "更新当前团队成员身份", ResourceCode: "team_member", ActionCode: "update_role", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "update_role", "team"), tenantHandler.UpdateMyMemberRole)
	reg.GET("/my-team/members/:userId/roles", &apiregistry.RouteMeta{Summary: "获取当前团队成员角色", ResourceCode: "team_member", ActionCode: "assign_role", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "assign_role", "team"), tenantHandler.GetMyTeamMemberRoles)
	reg.PUT("/my-team/members/:userId/roles", &apiregistry.RouteMeta{Summary: "配置当前团队成员角色", ResourceCode: "team_member", ActionCode: "assign_role", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "assign_role", "team"), tenantHandler.SetMyTeamMemberRoles)
	reg.GET("/my-team/members/:userId/actions", &apiregistry.RouteMeta{Summary: "获取当前团队成员功能权限", ResourceCode: "team_member", ActionCode: "assign_action", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "assign_action", "team"), tenantHandler.GetMyTeamMemberActionPermissions)
	reg.PUT("/my-team/members/:userId/actions", &apiregistry.RouteMeta{Summary: "配置当前团队成员功能权限", ResourceCode: "team_member", ActionCode: "assign_action", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "assign_action", "team"), tenantHandler.SetMyTeamMemberActionPermissions)
	reg.GET("/my-team/roles", &apiregistry.RouteMeta{Summary: "获取当前团队可分配角色", ResourceCode: "team_member", ActionCode: "assign_role", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "assign_role", "team"), tenantHandler.ListMyTeamRoles)
	reg.GET("/my-team/roles/:roleId/actions", &apiregistry.RouteMeta{Summary: "获取当前团队角色功能权限", ResourceCode: "team_member", ActionCode: "assign_action", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team_member", "assign_action", "team"), tenantHandler.GetMyTeamRoleActions)
	reg.GET("/my-team/actions", &apiregistry.RouteMeta{Summary: "获取当前团队功能权限边界", ResourceCode: "team", ActionCode: "configure_action_boundary", ScopeCode: "team", RequiresTenantContext: true}, authzService.RequireAction("team", "configure_action_boundary", "team"), tenantHandler.GetMyTeamActions)

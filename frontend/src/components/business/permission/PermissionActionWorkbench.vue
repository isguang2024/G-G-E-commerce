  ...
  <div class="permission-workbench">
    <div class="workbench-toolbar">
      <div class="toolbar-main">
        ...
        <ElSelect v-model="stateFilter" :placeholder="stateFilterPlaceholder" class="toolbar-select">
          <ElOption
        ...
        <ElCollapse v-model="activeFeatures" class="feature-collapse">
          ...
          >
            ...
            <div class="module-list">
              <section
                v-for="module in feature.modules"
                :key="module.key"
                class="module-card"
              >
...
const batchCommands = computed(() => {
  if (props.mode === 'menu' || props.mode === 'team') {
    return [
      { command: 'select-visible', label: props.mode === 'team' ? '批量开通当前结果' : '批量选中当前结果' },
      { command: 'clear-visible', label: props.mode === 'team' ? '批量关闭当前结果' : '批量取消当前结果' },

<template>
  <ElDrawer
    v-model="visible"
    :title="`协作空间功能包 - ${collaborationName}`"
    size="1280px"
    destroy-on-close
  ...
  >
    <div class="dialog-shell" v-loading="loading">
      ...
      <div class="summary-card">
        <ElTag type="primary" effect="light" round>协作空间 {{ collaborationName }}</ElTag>
...
<script setup lang="ts">
  ...
  const collaborationName = computed(() => props.collaborationName || '')

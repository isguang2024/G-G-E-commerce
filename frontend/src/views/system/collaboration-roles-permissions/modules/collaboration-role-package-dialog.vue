...
<script setup lang="ts">
  ...
  import {
    fetchGetMyCollaborationBoundaryPackages,
    fetchGetMyCollaborationBoundaryRolePackages,
    fetchSetMyCollaborationBoundaryRolePackages
  ...
  async function loadData() {
    ...
    try {
      const [listRes, roleRes] = await Promise.all([
        fetchGetMyCollaborationBoundaryPackages(currentAppKey.value),
        fetchGetMyCollaborationBoundaryRolePackages(
  ...
  async function handleSave() {
    ...
    saving.value = true
    try {
      await fetchSetMyCollaborationBoundaryRolePackages(
        props.roleData.roleId,

...
<script setup lang="ts">
  ...
  import {
    fetchCreateMyCollaborationRole,
    fetchUpdateMyCollaborationRole
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (props.dialogType === 'add') {
        await fetchCreateMyCollaborationRole(payload)
      } else {
        await fetchUpdateMyCollaborationRole(form.roleId, payload)
      }
